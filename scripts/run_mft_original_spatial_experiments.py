...
Companion to scripts/run_mft_original_mae_experiments.py. Same faithful original
...
entries — see pretrain/mft_spatial_mae.py) instead of standard MAE. The training
...
Run on physical GPU 2:
    bash scripts/run_mft_original_spatial_experiments.sh
or equivalently:
    CUDA_VISIBLE_DEVICES=2 python scripts/run_mft_original_spatial_experiments.py
