...
from coffe_compat import normalize_model_name
from models import CoFFE, MFTOriginal
...
def load_model_with_checkpoint(
    ...
    normalised here through ``coffe_compat`` (PAPER_CANON §7.3).
    """
...
def main(args):
    ...
    if args.output:
        output_data = {
            ...
            # pre-paper class names via coffe_compat.LEGACY_MODEL_TYPES.
