...
#
# Usage:
#   bash scripts/run_native_sem_pad_experiments.sh                  # all three, GPU 2
#   GPU=0 bash scripts/run_native_sem_pad_experiments.sh            # pick a GPU
#   DATASETS="trento muufl" bash scripts/run_native_sem_pad_experiments.sh   # subset
#   SKIP_ADAPT=1 bash scripts/run_native_sem_pad_experiments.sh     # eval only (reuse checkpoints)
#   SKIP_EVAL=1  bash scripts/run_native_sem_pad_experiments.sh     # adapt only
#
set -euo pipefail
