...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--temperature", type=float, default=10.0, help="Temperature scaling for cosine similarity"
    )
    parser.add_argument(
        "--prototype-mode",
        type=str,
    ...
    # Other
    parser.add_argument(
        "--seed", type=int, default=42, help="Random seed (used if --seeds not provided)"
    )
    parser.add_argument(
        "--seeds",
        type=int,
    ...
    parser.add_argument(
        "--num-example-episodes",
        type=int,
        default=3,
        help="Number of episodes to generate per-episode t-SNE feature space plots for. 0 to skip.",
    )
    parser.add_argument(
        "--max-tsne-samples",
        type=int,
