...
if __name__ == "__main__":
    ...
    parser.add_argument("--spat-ckpt", type=str, default="checkpoints/hypersigma/spat-vit-base.pth")
    parser.add_argument("--spec-ckpt", type=str, default="checkpoints/hypersigma/spec-vit-base.pth")
    parser.add_argument(
        "--adapted-checkpoint",
        type=str,
        default=None,
    ...
    parser.add_argument(
        "--prototype-mode", type=str, default="mean_features", choices=["mean_features"]
    )  # mean_distances not used for the dual feature
