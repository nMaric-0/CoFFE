...
Merges:
  * experiments/_report_raw.json        (verbatim configs / metadata / results)
...
Output: experiments/hypersigma_native_sem_pca100_report.json
"""
...
def main() -> None:
    raw = load_json(EXP / "_report_raw.json")
    ...
    report = {
        ...
        "generator": "scripts/build_native_pca100_report.py (raw: gather_native_pca100_raw.py; "
    ...
    out = EXP / "hypersigma_native_sem_pca100_report.json"
